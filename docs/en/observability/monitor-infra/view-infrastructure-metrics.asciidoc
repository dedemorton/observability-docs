...
The *Infrastructure Inventory* provides a metrics-driven view of your entire infrastructure grouped by
...
To open **Infrastructure Inventory**, find **Infrastructure** in the main menu or use the <<kibana-navigation-search,global search field>>.
